...
/**
 * Description of ListZonesBySlaveGroup
 *
 * @author fabricio.xavier
 */
class ListZonesBySlaveGroup extends DnsShimSocket {

    private $schemaName = 'ListZonesBySlaveGroupRequest';
